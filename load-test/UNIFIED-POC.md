...
Skenario dijalankan secara simultan selama **8 menit** (480 detik) untuk memberi durasi evaluasi yang cukup bagi Datadog Monitor dengan agregasi `avg(last_5m)`.
...
## 5. Acceptance Criteria (Menit ke-5 s.d Menit ke-8)
...
4. **Datadog Composite Monitor** berubah status dari `OK` menjadi **`ALERT / CRITICAL`** pada menit ke-5.
...
Setelah runner 480 detik selesai dan `./cleanup-full-poc.sh` dijalankan:
