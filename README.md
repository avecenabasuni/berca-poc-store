...
| `NEXT_PUBLIC_MEDUSA_BACKEND_URL` | Optional local proxy destination; browser requests use `/api/medusa` on the storefront origin | `http://localhost:9000` |
| `MEDUSA_BACKEND_URL_INTERNAL` | Internal Medusa URL used by SSR, middleware, and the browser API proxy | `http://medusa:9000` |
