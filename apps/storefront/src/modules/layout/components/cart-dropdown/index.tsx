            ...
            <>
              ...
              >
                <PopoverPanel
                  static
                  aria-label={t.title}
                  className="surface-elevated absolute right-0 top-[calc(100%+12px)] z-[100] flex max-h-[calc(100dvh-7rem)] w-[min(480px,calc(100vw-3rem))] flex-col overflow-hidden rounded-2xl bg-surface-default text-content-primary"
                ...
                >
                  ...
                  {cartState && cartState.items?.length ? (
                    ...
                    <div className="flex flex-col items-center justify-center gap-y-4 py-12">
                      <div className="flex h-8 w-8 items-center justify-center rounded-full bg-surface-inverse text-xs font-bold text-content-inverse">
                        <span>0</span>
                      </div>
