    ...
    >
      <Popover className="relative h-full flex items-center">
        ...
        >
          <PopoverPanel
            static
            className="hidden small:block absolute top-[calc(100%+12px)] right-0 bg-white border border-[#CFCFD4]/60 w-[450px] sm:w-[480px] text-[#1E1F74] rounded-2xl shadow-2xl z-[100]"
              ...
              <>
                <div className="overflow-y-scroll max-h-[380px] p-4 flex flex-col gap-y-6 no-scrollbar">
                  {cartState.items
                    ...
                    .map((item) => (
                      <div
                        className="grid grid-cols-[72px_1fr] gap-x-4 pb-4 border-b border-[#CFCFD4]/30 last:border-b-0 last:pb-0"
                        key={item.id}
                        data-testid="cart-item"
                      >
                        <LocalizedClientLink
                          href={`/products/${item.product_handle}`}
                          className="w-18 h-18 rounded-lg overflow-hidden border border-[#CFCFD4]/40 flex-shrink-0"
                        >
                          <Thumbnail
                        ...
                        <div className="flex flex-col justify-between flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-x-3">
                            <div className="flex flex-col flex-1 min-w-0">
                              <h3 className="text-sm font-semibold text-[#1E1F74] truncate">
                                <LocalizedClientLink
                                  href={`/products/${item.product_handle}`}
                              ...
                              />
                              <span
                                className="text-xs text-[#1E1F74]/70 mt-0.5"
